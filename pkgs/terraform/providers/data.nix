  ...
  alicloud =
    {
      ...
      version = "1.15.0";
      sha256  = "07zg5c99bbf598j5wi7yd6qr4hwizp5f74fmdmjdbqswa31kzqsh";
    };
  archive =
    {
      owner   = "terraform-providers";
  ...
  azurestack =
    {
      ...
      version = "0.3.0";
      sha256  = "1p73111bf3yyk8xzaj6kdiw6j9s6vh2b2a8l9rjyhh0cp4znycld";
    };
  bitbucket =
    {
      owner   = "terraform-providers";
  ...
  google =
    {
      ...
      version = "1.17.1";
      sha256  = "0qyfm1s4cssg06sgaixm7k1qkxm81q7k9vwjxl5lyxfafmwz0knr";
    };
  grafana =
    {
      owner   = "terraform-providers";
